    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row g-0">
                    <div class="col-sm-5">
                    	<div class="background_bg h-100" data-img-src="/assets_client/images/popup_img.jpg"></div>
                    </div>
                    <div class="col-sm-7">
                                            ...
                                            <div class="header_banner_content">
                                                <div class="shop_banner">
                                                    <div class="banner_img overlay_bg_40">
                                                        <img src="/assets_client/images/shop_banner.jpg" alt="shop_banner"/>
                                                    </div>
...
<div class="banner_section slide_medium shop_banner_slider staggered-animation-wrap">
    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active background_bg" data-img-src="/assets_client/images/banner1.jpg">
            ...
            <div class="carousel-item background_bg" data-img-src="/assets_client/images/banner2.jpg">
                <div class="banner_slide_content">
                    <div class="container"><!-- STRART CONTAINER -->
                        <div class="row">
                            <div class="col-lg-6">
            ...
            <div class="carousel-item background_bg" data-img-src="/assets_client/images/banner3.jpg">
                <div class="banner_slide_content">
                    <div class="container"><!-- STRART CONTAINER -->
                        <div class="row">
                            <div class="col-lg-6">
    	...
    	<div class="row">
        	<div class="col-md-6">
            	<div class="single_banner">
                	<img src="/assets_client/images/shop_banner_img1.jpg" alt="shop_banner_img1"/>
            ...
            <div class="col-md-6">
            	<div class="single_banner">
                	<img src="/assets_client/images/shop_banner_img2.jpg" alt="shop_banner_img2"/>
                    <div class="single_banner_info">
                        ...
                        <div class="row shop_container">
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="/assets_client/images/product_img6.jpg" alt="product_img6">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="/assets_client/images/product_img7.jpg" alt="product_img7">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="/assets_client/images/product_img8.jpg" alt="product_img8">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                        ...
                        <div class="row shop_container">
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="/assets_client/images/product_img9.jpg" alt="product_img9">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="/assets_client/images/product_img11.jpg" alt="product_img11">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="/assets_client/images/product_img12.jpg" alt="product_img12">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="/assets_client/images/product_img10.jpg" alt="product_img10">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
    	...
    	<div class="row align-items-center flex-row-reverse">
            ...
            <div class="col-md-5">
                <div class="text-center trading_img">
                    <img src="/assets_client//images/tranding_img.png" alt="tranding_img"/>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-9">
            	<div class="testimonial_wrap testimonial_style1 carousel_slider owl-carousel owl-theme nav_style2" data-nav="true" data-dots="false" data-center="true" data-loop="true" data-autoplay="true" data-items='1'>
                	<div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="/assets_client/images/user_img1.jpg" alt="user_img1" />
                            </div>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="/assets_client/images/user_img2.jpg" alt="user_img2" />
                            </div>
                            <div class="author_name">
                                <h6>Alden Smith</h6>
                                <span>Designer</span>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="/assets_client/images/user_img3.jpg" alt="user_img3" />
                            </div>
                            <div class="author_name">
                                <h6>Daisy Lana</h6>
                                <span>Designer</span>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="/assets_client/images/user_img4.jpg" alt="user_img4" />
                            </div>
                            <div class="author_name">
                                <h6>John Becker</h6>
                                <span>Designer</span>
