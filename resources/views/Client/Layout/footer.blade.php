<footer class="site-footer">
    ...
    <div class="footer-top py-4" style="background: linear-gradient(135deg, #0f2027, #203a43, #2c5364);">
        <div class="container">
    ...
    <!-- Main footer content -->
    <section class="footer-main py-5" style="background-color: #0d1117;">
        <div class="container">
            <div class="row g-4">
                <!-- Công ty / Giới thiệu -->
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <ul class="footer-links list-unstyled mb-0">
                        ...
                        <li><a href="#">Cho thuê BĐS</a></li>
                    </ul>
                </div>

                <!-- Liên kết nhanh -->
                <div class="col-lg-2 col-md-6">
                    <h6 class="footer-title text-uppercase fw-bold text-white mb-3">Liên kết</h6>
                    <ul class="footer-links list-unstyled mb-0">
                        <li><a href="/">Trang chủ</a></li>
                        <li><a href="#">Giới thiệu</a></li>
                        <li><a href="#">Tin tức BĐS</a></li>
                ...
                <!-- Liên hệ -->
                <div class="col-lg-4 col-md-6">
                    <h6 class="footer-title text-uppercase fw-bold text-white mb-3">Liên hệ</h6>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start mb-2 mb-md-0">
                    <span class="text-white-50 small">© {{ date('Y') }} Bất động sản Đà Nẵng. All rights
                        reserved.</span>
                </div>
