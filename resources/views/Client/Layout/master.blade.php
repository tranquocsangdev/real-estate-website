                                ...
                                <div class="row shop_container">
                                        ...
                                        <div class="product">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img1.jpg"
                                                        alt="product_img1">
                                                </a>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6">
                                        <div class="product">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img2.jpg"
                                                        alt="product_img2">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6">
                                        <div class="product">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img3.jpg"
                                                        alt="product_img3">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6">
                                        <div class="product">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img4.jpg"
                                                        alt="product_img4">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6">
                                        <div class="product">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img5.jpg"
                                                        alt="product_img5">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6">
                                        <div class="product">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img6.jpg"
                                                        alt="product_img6">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6">
                                        <div class="product">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img7.jpg"
                                                        alt="product_img7">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6">
                                        <div class="product">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img8.jpg"
                                                        alt="product_img8">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                ...
                                <div class="row shop_container">
                                    <div class="col-lg-3 col-md-4 col-6">
                                        <div class="product">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img9.jpg"
                                                        alt="product_img9">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6">
                                        <div class="product">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img11.jpg"
                                                        alt="product_img11">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6">
                                        <div class="product">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img12.jpg"
                                                        alt="product_img12">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6">
                                        <div class="product">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="/assets_client/images/product_img10.jpg"
                                                        alt="product_img10">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
