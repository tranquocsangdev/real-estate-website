...
<head>
    ...
    <style>
        ...
        .client-register-page .register-card .card-body {
            padding: 2.25rem 2rem;
        }

        .client-register-page .register-card .form-label {
            font-weight: 600;
            color: #1e293b;
            font-size: 0.875rem;
        ...
        .client-register-page .register-card .form-control::placeholder {
            color: #94a3b8;
        }

        .client-register-page .register-card .form-control:focus {
            border-color: #1e293b;
        ...
        .client-register-page .register-card .input-group .form-control {
            border-radius: 10px 0 0 10px;
        }

        .client-register-page .register-card .input-group .form-control:last-child {
            border-radius: 0 10px 10px 0;
            border-left: 0;
        }

        .client-register-page .register-card .input-group.has-toggle .form-control {
            border-radius: 10px 0 0 10px;
        }
        ...
        .client-register-page .btn-register:hover {
            background: #0f172a;
            color: #fff;
        }

        .client-register-page .btn-register:active {
        ...
        .client-register-page .btn-social:hover {
            background: #f8fafc;
            border-color: #cbd5e1;
            color: #1e293b;
        }

        .client-register-page .register-title {
            font-size: 1.5rem;
            font-weight: 700;
            color: #0f172a;
        ...
        .client-register-page .register-sub {
            color: #64748b;
            font-size: 0.875rem;
            margin-bottom: 1.5rem;
        }

        .client-register-page .divider {
            display: flex;
            align-items: center;
            gap: 1rem;
            margin: 1.25rem 0;
        ...
        .client-register-page .divider::before,
        .client-register-page .divider::after {
            content: '';
            flex: 1;
            height: 1px;
            background: #e2e8f0;
        ...
        .client-register-page .logo-wrap {
            text-align: center;
            margin-bottom: 1.25rem;
        }

        .client-register-page .logo-wrap img {
            max-width: 140px;
            height: auto;
        }

        .client-register-page .link-login {
            color: #1e293b;
            font-weight: 600;
            text-decoration: none;
        }

        .client-register-page .link-login:hover {
            color: #0f172a;
                    ...
                    <form class="row g-3" method="POST" action="{{ url('/user/register') }}">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group has-toggle" id="show_hide_password">
                                <input type="password" class="form-control border-end-0" id="inputPassword"
                        ...
                        <div class="col-12 pt-2">
                            <button type="submit" class="btn btn-primary btn-register w-100"><i
                                    class="bx bx-user-plus me-1"></i>Đăng ký</button>
